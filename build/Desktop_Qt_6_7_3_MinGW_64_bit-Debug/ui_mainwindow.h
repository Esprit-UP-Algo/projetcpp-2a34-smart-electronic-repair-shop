...
public:
    ...
    QPushButton *BTN_PREDICTION_DELAI;
    QPushButton *predic;
    ...
    QPushButton *BTN_TRIER;
    QTableView *TABLE_REPARATION;
...
"font: 900 12pt \"Swis721 BlkCn BT\";"));
        ...
        groupBoxFormulaireAppareils = new QGroupBox(groupBoxListeAppareils);
...
"color: rgb(255, 255, 255);"));
        ...
        verticalLayoutListeAppareils->addWidget(groupBoxFormulaireAppareils);
...
"background-color: #2c3147;"));
        ...
        label = new QLabel(groupBoxFormulaireReparations);
        label->setObjectName("label");
        label->setStyleSheet(QString::fromUtf8("color:white;\n"
""));

        formLayoutReparations->setWidget(0, QFormLayout::LabelRole, label);

        IDR = new QLineEdit(groupBoxFormulaireReparations);
        IDR->setObjectName("IDR");
        IDR->setStyleSheet(QString::fromUtf8("background-color:white;"));

        formLayoutReparations->setWidget(0, QFormLayout::FieldRole, IDR);
...
"color: rgb(255, 255, 255);"));
        ...
        formLayoutReparations->setWidget(1, QFormLayout::LabelRole, labelIdReparation);

        CIN_EMP = new QLineEdit(groupBoxFormulaireReparations);
        CIN_EMP->setObjectName("CIN_EMP");
        CIN_EMP->setStyleSheet(QString::fromUtf8("background-color:white;"));

        formLayoutReparations->setWidget(1, QFormLayout::FieldRole, CIN_EMP);
...
"color: rgb(255, 255, 255);"));
        ...
        formLayoutReparations->setWidget(2, QFormLayout::LabelRole, labelAppareilReparation);

        MAT_REP = new QLineEdit(groupBoxFormulaireReparations);
        MAT_REP->setObjectName("MAT_REP");
        MAT_REP->setStyleSheet(QString::fromUtf8("background-color:white;"));

        formLayoutReparations->setWidget(2, QFormLayout::FieldRole, MAT_REP);

        label_2 = new QLabel(groupBoxFormulaireReparations);
        label_2->setObjectName("label_2");
        label_2->setStyleSheet(QString::fromUtf8("color:white"));

        formLayoutReparations->setWidget(3, QFormLayout::LabelRole, label_2);

        NUM_SERIE = new QLineEdit(groupBoxFormulaireReparations);
        NUM_SERIE->setObjectName("NUM_SERIE");
        NUM_SERIE->setStyleSheet(QString::fromUtf8("background-color:white;"));

        formLayoutReparations->setWidget(3, QFormLayout::FieldRole, NUM_SERIE);
...
"color: rgb(255, 255, 255);"));
        ...
        formLayoutReparations->setWidget(4, QFormLayout::LabelRole, labelDateDepot);

        DATE_REC = new QDateEdit(groupBoxFormulaireReparations);
        DATE_REC->setObjectName("DATE_REC");
        DATE_REC->setStyleSheet(QString::fromUtf8("background-color: rgb(255, 255, 255);font: 9pt \"Segoe UI\";\n"
"color: black;\n"
"border-color: rgb(0, 0, 0);"));
        DATE_REC->setCalendarPopup(true);

        formLayoutReparations->setWidget(4, QFormLayout::FieldRole, DATE_REC);
...
"color: rgb(255, 255, 255);"));
        ...
        formLayoutReparations->setWidget(5, QFormLayout::LabelRole, labelDateRetourPrevue);

        DATE_FIN_EST = new QDateEdit(groupBoxFormulaireReparations);
        DATE_FIN_EST->setObjectName("DATE_FIN_EST");
        DATE_FIN_EST->setStyleSheet(QString::fromUtf8("background-color: rgb(255, 255, 255);font: 9pt \"Segoe UI\";\n"
"color: black;\n"
"border-color: rgb(0, 0, 0);"));
        DATE_FIN_EST->setCalendarPopup(true);

        formLayoutReparations->setWidget(5, QFormLayout::FieldRole, DATE_FIN_EST);
...
"color: rgb(255, 255, 255);"));
        ...
        formLayoutReparations->setWidget(6, QFormLayout::LabelRole, labelPanne);

        DES_PANNE = new QTextEdit(groupBoxFormulaireReparations);
        DES_PANNE->setObjectName("DES_PANNE");
        DES_PANNE->setMaximumSize(QSize(16777215, 80));
        DES_PANNE->setStyleSheet(QString::fromUtf8("background-color: rgb(255, 255, 255);\n"
"color: black;\n"
"border-color: rgb(0, 0, 0);"));

        formLayoutReparations->setWidget(6, QFormLayout::FieldRole, DES_PANNE);
...
"color: rgb(255, 255, 255);"));
        ...
        formLayoutReparations->setWidget(7, QFormLayout::LabelRole, labelStatutReparation);

        STATUT_R = new QComboBox(groupBoxFormulaireReparations);
        STATUT_R->addItem(QString());
        STATUT_R->addItem(QString());
        STATUT_R->addItem(QString());
        STATUT_R->addItem(QString());
        STATUT_R->setObjectName("STATUT_R");
        STATUT_R->setStyleSheet(QString::fromUtf8("background-color: rgb(255, 255, 255);\n"
"font: 10pt \"Segoe UI\";\n"
"color: black;\n"
"border-color: rgb(0, 0, 0);"));

        formLayoutReparations->setWidget(7, QFormLayout::FieldRole, STATUT_R);
...
"color: rgb(255, 255, 255);"));
        ...
        formLayoutReparations->setWidget(8, QFormLayout::LabelRole, labelCout);

        COUT = new QLineEdit(groupBoxFormulaireReparations);
        COUT->setObjectName("COUT");
        COUT->setStyleSheet(QString::fromUtf8("background-color: rgb(255, 255, 255);\n"
"color: black;\n"
"border-color: rgb(0, 0, 0);"));

        formLayoutReparations->setWidget(8, QFormLayout::FieldRole, COUT);
        ...
        BTN_AJOUTER = new QPushButton(groupBoxFormulaireReparations);
        BTN_AJOUTER->setObjectName("BTN_AJOUTER");
        BTN_AJOUTER->setStyleSheet(QString::fromUtf8("background-color: #28A745;\n"
"font: 900 12pt \"Swis721 BlkCn BT\";\n"
"color: rgb(255, 255, 255);"));

        horizontalLayoutButtonsReparations->addWidget(BTN_AJOUTER);

        BTN_MODIFIER = new QPushButton(groupBoxFormulaireReparations);
        BTN_MODIFIER->setObjectName("BTN_MODIFIER");
        BTN_MODIFIER->setStyleSheet(QString::fromUtf8("background-color: #007BFF;\n"
"color: rgb(255, 255, 255);\n"
"font: 900 12pt \"Swis721 BlkCn BT\";"));

        horizontalLayoutButtonsReparations->addWidget(BTN_MODIFIER);

        BTN_SUPPRIMER = new QPushButton(groupBoxFormulaireReparations);
        BTN_SUPPRIMER->setObjectName("BTN_SUPPRIMER");
        BTN_SUPPRIMER->setStyleSheet(QString::fromUtf8("background-color: #DC3545;\n"
"font: 900 12pt \"Swis721 BlkCn BT\";\n"
"color: rgb(255, 255, 255);"));

        horizontalLayoutButtonsReparations->addWidget(BTN_SUPPRIMER);


        formLayoutReparations->setLayout(9, QFormLayout::SpanningRole, horizontalLayoutButtonsReparations);

        BTN_PREDICTION_DELAI = new QPushButton(groupBoxFormulaireReparations);
        BTN_PREDICTION_DELAI->setObjectName("BTN_PREDICTION_DELAI");
        QPalette palette;
        QBrush brush(QColor(255, 255, 255, 255));
        brush.setStyle(Qt::SolidPattern);
        palette.setBrush(QPalette::Active, QPalette::WindowText, brush);
        QBrush brush1(QColor(100, 178, 230, 255));
        ...
        QBrush brush2(QColor(31, 155, 93, 255));
...
#endif
        BTN_PREDICTION_DELAI->setPalette(palette);
        BTN_PREDICTION_DELAI->setStyleSheet(QString::fromUtf8("background-color:#64b2e6;\n"
"color: white;"));

        formLayoutReparations->setWidget(10, QFormLayout::FieldRole, BTN_PREDICTION_DELAI);

        predic = new QPushButton(groupBoxFormulaireReparations);
        predic->setObjectName("predic");
        QPalette palette1;
...
#endif
        predic->setPalette(palette1);
        predic->setStyleSheet(QString::fromUtf8("background-color:#ff5500;\n"
"color: white;\n"
""));

        formLayoutReparations->setWidget(10, QFormLayout::LabelRole, predic);
...
"color: black;"));
        ...
        RECHERCHE = new QLineEdit(groupBoxListeReparations);
        RECHERCHE->setObjectName("RECHERCHE");
        RECHERCHE->setStyleSheet(QString::fromUtf8("font: 9pt \"Segoe UI\";\n"
"background-color: rgb(255, 255, 255);\n"
"color: black;"));

        horizontalLayoutRechercheReparations->addWidget(RECHERCHE);

        BTN_RECHERCHER = new QPushButton(groupBoxListeReparations);
        BTN_RECHERCHER->setObjectName("BTN_RECHERCHER");
        BTN_RECHERCHER->setStyleSheet(QString::fromUtf8("font: 900 12pt \"Swis721 BlkCn BT\";\n"
"background-color: #007BFF;\n"
"color: white;"));

        horizontalLayoutRechercheReparations->addWidget(BTN_RECHERCHER);

        BTN_TRIER = new QPushButton(groupBoxListeReparations);
        BTN_TRIER->setObjectName("BTN_TRIER");
        BTN_TRIER->setStyleSheet(QString::fromUtf8("background-color: #6C757D;\n"
"color: rgb(255, 255, 255);\n"
"font: 900 12pt \"Swis721 BlkCn BT\";"));

        horizontalLayoutRechercheReparations->addWidget(BTN_TRIER);


        verticalLayoutListeReparations->addLayout(horizontalLayoutRechercheReparations);

        TABLE_REPARATION = new QTableView(groupBoxListeReparations);
        TABLE_REPARATION->setObjectName("TABLE_REPARATION");
        TABLE_REPARATION->setStyleSheet(QString::fromUtf8("background-color: rgb(255, 255, 255);"));
        TABLE_REPARATION->setSelectionMode(QAbstractItemView::SelectionMode::SingleSelection);
        TABLE_REPARATION->setSelectionBehavior(QAbstractItemView::SelectionBehavior::SelectRows);
        TABLE_REPARATION->setSortingEnabled(true);

        verticalLayoutListeReparations->addWidget(TABLE_REPARATION);
...
"color: rgb(255, 255, 255);"));
        ...
        BTN_EXPORTER = new QPushButton(groupBoxListeReparations);
        BTN_EXPORTER->setObjectName("BTN_EXPORTER");
        BTN_EXPORTER->setStyleSheet(QString::fromUtf8("background-color: #DC3545;\n"
"color: rgb(255, 255, 255);\n"
"font: 900 12pt \"Swis721 BlkCn BT\";"));

        horizontalLayoutExportReparations->addWidget(BTN_EXPORTER);
...
"border-radius: 8px;"));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        label->setToolTip(QCoreApplication::translate("MainWindow", "color:white;", nullptr));
#endif // QT_CONFIG(tooltip)
        label->setText(QCoreApplication::translate("MainWindow", "id reparation", nullptr));
        labelIdReparation->setText(QCoreApplication::translate("MainWindow", "CIN employe :", nullptr));
        labelAppareilReparation->setText(QCoreApplication::translate("MainWindow", "Matricule reparation :", nullptr));
        label_2->setText(QCoreApplication::translate("MainWindow", "numero serie", nullptr));
        ...
        STATUT_R->setItemText(0, QCoreApplication::translate("MainWindow", "En attente", nullptr));
        STATUT_R->setItemText(1, QCoreApplication::translate("MainWindow", "En cours", nullptr));
        STATUT_R->setItemText(2, QCoreApplication::translate("MainWindow", "Termin\303\251e", nullptr));
        STATUT_R->setItemText(3, QCoreApplication::translate("MainWindow", "Annul\303\251e", nullptr));
        ...
        BTN_PREDICTION_DELAI->setText(QCoreApplication::translate("MainWindow", "pr\303\251diction D\303\251lais", nullptr));
        predic->setText(QCoreApplication::translate("MainWindow", "notifier client", nullptr));
        ...
        RECHERCHE->setPlaceholderText(QCoreApplication::translate("MainWindow", "Terme de recherche...", nullptr));
        BTN_RECHERCHER->setText(QCoreApplication::translate("MainWindow", "Rechercher", nullptr));
        BTN_TRIER->setText(QCoreApplication::translate("MainWindow", "Trier par cout", nullptr));
        labelTotalReparations->setText(QCoreApplication::translate("MainWindow", "Total: 0 r\303\251parations", nullptr));
        BTN_EXPORTER->setText(QCoreApplication::translate("MainWindow", "Exporter PDF", nullptr));
